...
public class PaymentTest {
    ...
    public void shouldValidateDummyPaymentBuyerName(){
        ...
        assertEquals(1,
                violations
                        .stream()
                        .filter(viol -> viol.getMessage().equals(Buyer.NAME_NULL_VALIDATION_MESSAGE))
                        .count());
    }
    ...
    public void shouldValidateDummyPaymentBuyerNameInvalid(){
        ...
        assertEquals(1,
                violations
                        .stream()
                        .filter(viol -> viol.getMessage().equals(Buyer.NAME_FORMAT_INVALID_MESSAGE))
                        .count());
    }
    ...
    public void shouldValidateDummyPaymentBuyerEmail(){
        ...
        assertEquals(1,
                violations
                        .stream()
                        .filter(viol -> viol.getMessage().equals(Buyer.EMAIL_NULL_VALIDATION_MESSAGE))
                        .count());
    }
    ...
    public void shouldValidateDummyPaymentBuyerEmailInvalid(){
        ...
        assertEquals(1,
                violations
                        .stream()
                        .filter(viol -> viol.getMessage().equals(Buyer.EMAIL_FORMAT_INVALID_MESSAGE))
                        .count());
    }
